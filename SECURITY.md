...
- The pinned GitHub Actions Linux workflow installs declared dependencies and runs offline
  It uses read-only permissions and disables persisted checkout credentials.
